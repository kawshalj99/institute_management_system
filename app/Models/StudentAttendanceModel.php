...
class StudentAttendanceModel extends Model
{
    ...
    {
        $return = StudentAttendanceModel::select('student_attendance.*', 'class.name as class_name', 'student.name as student_name', 'student.last_name as student_last_name', 'createdby.name as created_name', 'student.admission_number as ad_number')
                            ...
                            {
                                $return = $return->where('student.admission_number', '=', Request::get('student_id'));
                            }

...
class AssignClassTeacherController extends Controller
{
        ...
        if(!empty($request->teacher_id))
        {
            foreach ($request->teacher_id as $teacher_id)
            {
                ...
                if(!empty($getAlreadyFirst))
                {
                    ...
                    return redirect('admin/assign_class_teacher/list')->with('error',"Class Already Assign to the same Teacher");
                }
                else
                {
            ...
            return redirect('admin/assign_class_teacher/list')->with('success',"Class Successfully Assign to Teacher");
        }
        else
        {
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('admin/assign_class_teacher/list')->with('success',"Teacher Successfully Assign to Class");
    ...
    public function update_single($id, Request $request)
    {
        ...
        if(!empty($getAlreadyFirst))
        {
            ...
            return redirect('admin/assign_class_teacher/list')->with('error',"Teacher Already Assign to the same class");
        }
        else
        {

...
class ClassTimetableController extends Controller
{
        ...
        foreach($getWeek as $value)
        {
            ...
            if(!empty($request->class_id) && !empty($request->subject_id))
            {
                ...
                if(!empty($ClassSubject))
                {
                    ...
                    $dataW['hall_number'] = $ClassSubject->hall_number;
                }
                else
                {
                    $dataW['start_time'] = '';
    ...
    public function insert_update(Request $request)
    {
        ...
        {
            if(!empty($timetable['week_id']) && !empty($timetable['start_time']) && !empty($timetable['end_time']) && !empty($timetable['hall_number']))
            {
                ...
                $save->hall_number = $timetable['hall_number'];
                $save->save();
            }
        }
        return redirect()->back()->with('success', "Timetable Successfully Saved");
    }

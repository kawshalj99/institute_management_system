              ...
              <form method="get" action="">
                ...
                <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{ url('admin/assign_class_teacher/list')}}" class="btn btn-success" style="margin-top: 31px;"> Clear </a>
                  </div>
                  </div>
                </div>
              </form>
                ...
                <table class="table table-striped">
                  ...
                  @foreach($getRecord as $value)
                        <tr>
                          ...
                          <a href="{{ url('admin/assign_class_teacher/edit_single/'.$value->id)}}" class="btn btn-secondary">Edit Single</a>

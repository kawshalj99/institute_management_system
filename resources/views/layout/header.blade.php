    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
                <a href="{{url('student/my_homework')}}" class="nav-link @if(Request::segment(3) == 'my_homework') active @endif">
                  <i class="nav-icon fas fa-archive"></i>
                  <p>My Homework</p>
                </a>
          </li>
          ...
          <li class="nav-item">
                <a href="{{url('student/my_submitted_homework')}}" class="nav-link @if(Request::segment(3) == 'my_submitted_homework') active @endif">
          ...
          <li class="nav-item">
                <a href="{{url('student/my_notice_board')}}" class="nav-link @if(Request::segment(3) == 'my_notice_board') active @endif">
                  <i class="nav-icon fas fa-chalkboard"></i>
                  <p>My Notice Board</p>
                </a>
          </li>
